...
# LF Parameters
zdo = np.array([0.5, 1.3, 2.5])
zup = np.array([1.3, 2.5, 4.0])
zcen = (zdo + zup)/2

alp, alp_err = np.array([-0.64, -0.39, 0.86]), np.array([0.42, 0.53, 1.1])
logl, logl_err = np.array([11.91, 12.26, 12.36]), np.array([0.27, 0.22, 0.25])
logp, logp_err = np.array([-3.24, -3.07, -3.17]), np.array([0.275, 0.265, 0.29])
